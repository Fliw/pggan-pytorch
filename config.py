...
## general settings.
parser.add_argument('--train_data_root', type=str, default='/content/merged_dataset')
...
parser.add_argument('--save_img_every', type=int, default=10)       # save images every specified iteration.
